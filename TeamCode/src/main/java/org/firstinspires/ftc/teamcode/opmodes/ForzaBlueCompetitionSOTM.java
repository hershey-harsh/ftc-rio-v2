...
@Disabled
@TeleOp(name = "(FORZA) Blue Competition SOTM (FULL)", group = "Blue Forza")
public class ForzaBlueCompetitionSOTM extends NextFTCOpMode {
    ...
    public ForzaBlueCompetitionSOTM() {
        addComponents(
    ...
    public void onUpdate() {
        ...
        if (Shooter.INSTANCE.MODE == Shooter.Mode.ODOMETRY) {
            ...
            if (Configuration.CURRENT_POSE.getY() < 36) {
                // Close range: mirror of ForzaRedCompetitionSOTM (Red close = -2 -> Blue = +2).
