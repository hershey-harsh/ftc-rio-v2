...
//
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            ).setLinearHeadingInterpolation(Math.toRadians(138), Math.toRadians(152))
                    .build();
            ...
            ).setLinearHeadingInterpolation(Math.toRadians(152), Math.toRadians(138))
                    .build();
